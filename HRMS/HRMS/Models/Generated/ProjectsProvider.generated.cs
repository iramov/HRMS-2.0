...
{
	/// <summary>
	/// Provides methods for retrieving pages of type Projects.
	/// </summary>
	public partial class ProjectsProvider
	{
		/// <summary>
		/// Returns a query that selects published pages of type Projects.
		/// </summary>
		public static DocumentQuery<Projects> GetProjects()
		{
			return DocumentHelper.GetDocuments<Projects>().PublishedVersion().Published();
		}


		/// <summary>
		/// Returns a published page of type Projects that matches the specified criteria.
		/// </summary>
		...
		public static DocumentQuery<Projects> GetProjects(int nodeId, string cultureName, string siteName)
		{
		...
		/// <param name="siteName">The name of the site where the page belongs.</param>
		/// <param name="cultureName">The name of the language, e.g. en-US, that determines which localized version should be retrieved.</param>
		public static DocumentQuery<Projects> GetProjects(Guid nodeGuid, string cultureName, string siteName)
		{
		...
		/// <param name="siteName">The name of the site where the page belongs.</param>
		/// <param name="cultureName">The name of the language, e.g. en-US, that determines which localized version should be retrieved.</param>
		public static DocumentQuery<Projects> GetProjects(string nodeAliasPath, string cultureName, string siteName)
		{
