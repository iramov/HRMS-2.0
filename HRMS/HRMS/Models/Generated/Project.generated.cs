...
namespace CMS.DocumentEngine.Types
{
	...
	public partial class Project : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "HRMS.Project";
		...
		public string ProjectName
		{
			get
			{
				return ValidationHelper.GetString(GetValue("ProjectName"), "");
			}
			set
			{
		...
		public partial class ProjectFields
		{
			...
			public string Name
			{
				get
				{
					return mInstance.ProjectName;
				}
				set
				{
					mInstance.ProjectName = value;
				}
			}
